...
theorem insert_forward_sim
    (S : Interface.Schema) (m : Mem) (req : OrderRequest) (fuel : Nat)
    (bids_root asks_root : Option Path)
    (h_schema : SchemaAccepts S)
    ...
    ∃ m',
      execStmt (genC S) fuel (insertStmt req) m = .ok (m', Outcome.normal) ∧
      WfMem m' bids_root asks_root ∧
      alpha_concrete m' bids_root asks_root = some (abstract_insert emptyBook req.toOrder)
\end{lstlisting}
